<?php
    ...
    $this->set_css($this->default_theme_path.'/adminlte/css/AdminLTE.min.css');
...
<div class="crud-form" data-unique-hash="<?php echo $unique_hash; ?>">
    <div class="box box-primary gc-container">
        <div class="row">
            <div class="col-md-12">
                <div class="box-header with-border">
                    <h4 class="box-title"><?php echo $this->l('list_view'); ?> <?php echo $subject?></h4>
                </div>
